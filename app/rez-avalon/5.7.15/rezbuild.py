...
url_prefix = "https://github.com/getavalon/setup/archive"
...
def build(source_path, build_path, install_path, targets=None):
    ...
    payload = os.path.join(source_root, "core-{0}".format(os.environ["REZ_BUILD_PROJECT_VERSION"]))
    lib.copy_dir(payload, dst)
